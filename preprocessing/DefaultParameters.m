classdef DefaultParameters
    ...
    properties(Constant)        
        ...
        channel_rejection_params = struct('channel_criterion', 0.85,...
                                'line_noise_criterion', 4,...
                                'burst_criterion', 'off',...
                                'window_criterion', 'off', ...
                                'highpass', 'off', ...
                                'asr_url', 'http://sccn.ucsd.edu/eeglab/plugins/clean_rawdata0.32.zip', ...
                                'rar', 0, ...
        ...
        ica_params = struct('chanloc_map', containers.Map, ...
                            'bool', 0, ...
                            'req_chan_labels', {{'C3','C4','Cz','F3','F4','F7','F8','Fp1','Fp2','Fz','LM','NAS','O1','O2','Oz','P3','P4','P7','P8','Pz','RM','T7','T8'}}, ...
